    ...
    return (
        <List sx={{ pt: 0 }}>
            ...
            >
                ...
                <ListItemLink to="https://github.com/IMXEren/Suwayomi-WebUI" target="_blank" rel="noreferrer">
                    <ListItemText primary={t`GitHub WebUI`} secondary="https://github.com/IMXEren/Suwayomi-WebUI" />
                </ListItemLink>
